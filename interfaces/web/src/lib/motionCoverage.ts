  ...
  },
  {
    ...
    surfaces: [
      ...
      },
      {
        ...
        kind: MotionSurfaceKind.ScrollReveal,
        status: MotionCoverageStatus.Wired,
        notes: 'PageSectionReveal + rowStagger cascade in ProjectShowcaseGrid',
      },
    ],
  },
  {
    ...
    surfaces: [
      ...
      },
      {
        ...
        kind: MotionSurfaceKind.ScrollReveal,
        status: MotionCoverageStatus.Wired,
        notes: 'stagger tags + depth reveal on architecture/certificate columns',
      },
    ],
  },
  {
    ...
    surfaces: [
      ...
      },
      {
        ...
        kind: MotionSurfaceKind.ScrollReveal,
        status: MotionCoverageStatus.Wired,
        notes: 'trend chart plot-on-view + pulse dots + typewriter event log',
      },
      {
